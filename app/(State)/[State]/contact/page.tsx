...
export function generateMetadata({ params }: { params: { services: string } }) {
  ...
  return {
    ...
    description: `Need a dumpster rental in ${Data.name}? Contact All American Dumpster Service LLC for quick, reliable service and affordable rates. `,
    alternates: {
    ...
    <div className="flex flex-col  items-center justify-center  bg-white text-black ">
      <div className="  w-screen cursor-default text-lg  md:w-full">
        ...
        <Banner
          ...
          p1={`Need a dumpster rental in ${Data.name}? Contact All American Dumpster Service LLC for quick, reliable service and affordable rates.`}
        />
        {/* poster */}
        {/* -----------------------------------------button Start------------------------ */}
